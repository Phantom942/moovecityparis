...
<div class="form-row">
                ...
                <div class="form-row">
                    ...
                    <div id="priceEstimate" class="price-estimate-box hidden">
                        <div class="price-estimate-inner">
                            <div>
                                <span class="price-estimate-label">Devis ferme</span>
                        ...
                        <p class="price-estimate-note">Devis ferme et définitif. Aucun supplément caché.</p>
                    </div>
                    <div class="form-row">
                        <div class="form-field">
                ...
                <div class="form-footer">
                    <!-- CTA principal : paiement en ligne (placeholder Stripe — container à connecter) -->
                    <div id="stripe-payment-container" style="display: none; margin-bottom: 12px;"></div>
                    <button type="button" id="cta-pay-booking" onclick="alert('Paiement en ligne bientôt disponible. Contactez-nous par téléphone ou WhatsApp.')" class="btn-primary btn-cta" style="cursor: pointer; border: none; font-family: inherit;">
                    ...
                    <p class="form-footer-note" style="margin-top: 8px;">
                        Besoin d'aide ? <a href="#" onclick="redirectToWhatsAppBooking(); trackBookingWhatsApp(); return false;" style="color: #25d366; font-weight: 600; text-decoration: none;">Assistance WhatsApp</a> · Réponse immédiate 24h/7j
                    </p>
                </div>
